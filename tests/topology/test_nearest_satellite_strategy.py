...
from src.network_state.gsl_attachment.gsl_attachment_strategies.nearest_satellite import NearestSatelliteStrategy
...
class TestNearestSatelliteStrategy(unittest.TestCase):
    ...
    def test_select_attachments_multiple_ground_stations(self, mock_distance_func):
        ...
        result = self.strategy.select_attachments(
            self.mock_topology,
            self.mock_ground_stations,  # All 3 ground stations
            self.test_time
        )
